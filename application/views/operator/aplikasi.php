            ...
            <div class="card-body table-responsive p-o">
              <table id="example" class="table">
                ...
                <tbody>
                  <tr>
                    <td>Organisasi</td>
                    <td><b><?php if($kategori_data==1){ echo 'PC IPNU'; }else{ echo'PC IPPNU';} ?> <?= $aplikasi['nama_pimpinan']; ?></b></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td>Masa Khidmat</td>
                    <td><?= $aplikasi['masa_khidmat']; ?></td>
                    <td><form method="POST" action="<?=base_url()?>user/editaplikasi_text">
                  ...
                  <td><form method="POST" action="<?=base_url()?>user/editaplikasi_date">
                  ...
                  <tr>
                    ...
                    <td><form method="POST" action="<?=base_url()?>user/editaplikasi_dokumen">
                ...
                <tr>
                  ...
                  <td><form method="POST" action="<?=base_url()?>user/editaplikasi_foto">
            ...
            <div class="card-body table-responsive p-o">
              <table id="example" class="table">
                ...
                <tbody>
                  <tr>
                    <td>Organisasi</td>
                    <td><b><?php if($kategori_data==1){ echo 'PAC IPNU'; }else{ echo'PAC IPPNU';} ?> <?= $pac['nama_pimpinan_ac']; ?></b></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td>Masa Khidmat</td>
