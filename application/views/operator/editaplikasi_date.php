        ...
        <div class="card card-default">
          ...
          <div class="card-body table-responsive p-o">
              <div class="form-group">
                <form method="POST" action="<?=base_url(); ?>user/updateaplikasi_date" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  elseif ($kolom=='nama_sekretaris') {echo "Nama Sekretaris"; }elseif ($kolom=='nia_sekretaris') {echo "NIA Sekretaris"; }?></label>
									...
									<input class="form-control" type="date" name="kolom" value="<?= $aplikasi[$kolom]; ?>"> <br/>
