        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <h3 class="card-title"> <?= $pimpinan_cabang['nama_pimpinan']; ?> - <b>PAC <?= $pac['nama_pimpinan_ac']; ?> (<?= $pac['kd_pimpinan_ac']; ?>)</b></h3>
              <a style="float:right;" class="btn btn-info" href="<?= base_url();?>user/inranting?id=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id2']; ?>&id3=PK">New Data</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body table-responsive p-o">
              <table id="example1" class="table">
                ...
                <tr>
                  ...
                  <td>
                  <a class='btn btn-info' title='Edit Data' href='<?=base_url()?>user/editranting?id_rk=<?= $pimp['id_pimpinan_rk']; ?>&id=<?= $pimp['id_pimpinan_ac']; ?>&id2=<?= $pimp['id_pimpinan']; ?>&id3=PK'><span class='fa fa-edit'></span></a>
                    </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
