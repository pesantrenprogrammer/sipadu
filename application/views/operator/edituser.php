      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body table-responsive p-o">
            ...
            <input type="hidden" name="id_pimpinan" value="<?= $user['id_pimpinan'];?>"/>
              <div class="form-group">
                <label>Username</label>
                <input type="hidden" value="<?= $user['ket']; ?>" name='ket' />
              ...
              <div class="form-group">
                <input type="submit" class="btn bg-olive" name="edit" value="Save"/>
              </div>
            </form>
          </div>
          <!-- /.card-body -->
