...
<body> 
  ...
  <h4 align="center">Data Anggota<br/>
                    PKPT <?php if($kategori_data==1){ echo 'IPNU'; }else{ echo'IPPNU';} ?>
                    <?= $get_pac['nama_pimpinan_ac'];?><br/> <?= $get_pc['nama_pimpinan'];?></h4>
  <br/>
  Doc : <?php if($kategori_data==1){ echo 'PKPT IPNU'; }else{ echo'PKPT IPPNU';} ?> <?= $get_pac['nama_pimpinan_ac'];?><br/> <?= $get_pc['nama_pimpinan'];?>
  <br/>
              ...
              <table align="center" id="example1" class="table" border="1" cellpadding="10" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><?= $ang['nia']; ?></td>
                  <td><b><?= $ang['nama']; ?></b></td>
                  <td>PKPT <?= $ang['nama_pimpinan_ac']; ?></td>
