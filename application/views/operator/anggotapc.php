                ...
                <tr>
                  ...
                  <td>
                    <?php if($kategori_data==1){ ?>
                      <a target="_blank" class='btn btn-info' title='Print KTA IPNU' href='<?=base_url()?>user/printktaipnu?id=<?= $ang['id_anggota']; ?>&id2=<?= $ang['id_pimpinan']; ?>'>
                        <i class="fas fa-address-card"></i></a>
                      <?php }else{ ?>
                        <a target="_blank" class='btn btn-info' title='Print KTA IPPNU' href='<?=base_url()?>user/printktaippnu?id=<?= $ang['id_anggota']; ?>'>
                          <i class="fas fa-address-card"></i></a>
                      <?php } ?>
                      <a class='btn btn-warning' title='view Detail' href='<?=base_url()?>user/viewanggota?id=<?= $ang['id_anggota']; ?>'>
