      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body table-responsive p-0">
            <form action="<?=base_url()?>user/addanggota" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table class='table'>
            <tr>
            ...
            <td colspan="3">
              ...
              <input type="hidden" name="pw" value="11"/>
			  			<input type="hidden" name="jenis" value="PAC"/>
            ...
            **)NIA akan terinput otomatis setelah data disimpan</td>
             ...
             <td colspan="2"><input required="required" class="form-control" type="text" name="tempat_lahir"  value="" placeholder="Tempat Lahir"/></td><td><input type="date" name="tanggal_lahir" class="form-control pull-right"  placeholder="Tanggal Lahir"></td>
			  ...
			  <tr><td>Email</td>
             <td colspan="3"><input required="required" type="email" class="form-control"  name="email" id="email" placeholder="admin@ipnujateng.com"></td>
              </tr>
							<tr>
                ...
                <tr>
                 ...
                 <td>
									 ...
									 <select readonly type="text" class="form-control" id="id_pimpinan" name="id_pimpinan">
                    ...
                    <?php endforeach; ?>
						        ...
						        <script>
									...
									<tr><td>Aktif Kepengurusan</td>
										<td required="required" colspan="3">
						...
						<!--<tr>
		                 ...
		                 <td>Tempat Input KTA</td>
		                  <td colspan="3"><input class="form-control" readonly type="text" name="tempat_input_kta" value="<?= $get_pc['nama_pimpinan'];?>" class="form-control pull-right" placeholder="Tempat Input KTA (Kabupaten/Kota)"></td>
		              </tr>
		              <tr>
              ...
              <tr>
                ...
                <td></td>
                  <td colspan="3">
										...
										<a target="_blank" href="<?=base_url();?>user/printformanggota" class="btn btn-warning">Print Form Anggota</a>
									</td>
	...
	<div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash', 'Terpakai'); ?>"></div>
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body table-responsive p-0">
            <form action="<?=base_url()?>user/addanggotaippnu" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table class='table'>
            <tr>
            <td>Nomor Induk Anggota</td>
            <td colspan="3">
            ...
            **)NIA akan terinput otomatis setelah data disimpan</td>
             ...
             <td colspan="2"><input required="required" class="form-control" type="text" name="tempat_lahir"  value="" placeholder="Tempat Lahir"/></td><td><input type="date" name="tanggal_lahir" class="form-control pull-right"  placeholder="Tanggal Lahir"></td>
			  ...
			  <tr><td>Email</td>
             <td colspan="3"><input required="required" type="email" class="form-control"  name="email" id="email" placeholder="admin@ippnujateng.com"></td>
              </tr>
							<tr>
                 <td>Alamat Lengkap</td>
                 <td colspan="3"><textarea class="form-control"  name="alamat_lengkap" id="alamat_lengkap" style="height: 50px;width: 100%;"></textarea></td>
                 ...
                 <td>
                  ...
                  <td>Kaderisasi Non Formal</td>
											<td colspan="3">
												<div class="form-group">
				                  <select name="pelatihan_nonformal[]" class="select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
				                    <option>Latpel 1</option>
				                    <option>Latpel 2</option>
														<option>ISPT</option>
