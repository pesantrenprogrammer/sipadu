      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?=base_url()?>admin/dashboard" <?php if ($menu == 'dashboard') {
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url()?>admin/aplikasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Aplikasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/kodedaerah" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kode Daerah</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" <?php if ($menu == 'anggotapw' || $menu == 'anggotapc' || $menu == 'anggotapac' || $menu == 'anggotapr'|| $menu == 'inanggota'
            || $menu=='viewanggota' || $menu=='editanggota') {
                ?> class="nav-link active" <?php
            }else{ ?>class="nav-link"<?php } ?>>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url()?>admin/anggotapw" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manajemen Data Anggota</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/penguruspw" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Pengurus PW</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/anggotapc" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pimpinan Cabang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/anggotapac?id" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pimpinan Anak Cabang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/anggotapkpt?id" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PKPT</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/anggotapr?id=" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ranting / Komisariat</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/inanggota" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Data</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="<?=base_url();?>admin/daftarkegiatan" <?php if ($menu == 'daftarkegiatan') {
                ?> class="nav-link active" <?php
            }else{ ?>class="nav-link"<?php } ?>>
          ...
          <li class="nav-item has-treeview">
            <a href="<?=base_url();?>admin/downloadperaturan" <?php if ($menu == 'downloadperaturan') {
                ?> class="nav-link active" <?php
            }else{ ?>class="nav-link"<?php } ?>>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url()?>admin/statistikorganisasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Statistik Organisasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>admin/potensikader" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Potensi Kader</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>admin/about" <?php if ($menu == 'about') {
                ?> class="nav-link active" <?php
            }else{ ?>class="nav-link"<?php } ?>>
