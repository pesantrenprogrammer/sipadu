              ...
              <table id="example1" class="table no-border">
                ...
                <tbody>
                  ...
                  <?php  } ?>
                      ...
                      <br/>
                      <b><a href="<?=base_url();?>anggota/editfotoanggota?id=<?= $anggota['id_anggota']; ?>">Edit Foto Profil</a></b>
                    </td>
                    <td>NIA</td>
                    <td><?= $anggota['nia']; ?></td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2"><a class="form-control btn bg-info" href="<?=base_url()?>anggota/editanggota?id=<?= $anggota['id_anggota']; ?>">Edit Data</a></td>
                  </tr>
                </tbody>
