          ...
          <div class="card-body table-responsive p-0">
            ...
            **)NIA akan terinput otomatis setelah data disimpan</td>
             ...
             <td colspan="3"><input required="required" type="email" class="form-control"  name="email" id="email" placeholder="admin@ipnujateng.com"></td>
                 ...
                 <td colspan="3">
									 <textarea class="form-control"  name="alamat_lengkap" id="alamat_lengkap" style="height: 50px;width: 100%;"></textarea></td>
                  </tr>
									<tr>
                 ...
                 <td>
                  ...
                  <td>
                    ...
                    <?php endforeach; ?>
						 ...
						 <td colspan="3">
						  <div class="form-group">
						<select class="form-control" id="tempat_input_kta" name="tempat_input_kta">
						<option>Pilih Pimpinan Cabang</option>
						<?php foreach ($cabang as $pc): ?>
                    	<option value="<?= $pc['nama_pimpinan']; ?>">
                        <?= $pc['kd_pimpinan']; ?> - <?= $pc['nama_pimpinan']; ?>
                    	</option>
						<?php endforeach; ?>
	            		</select>
