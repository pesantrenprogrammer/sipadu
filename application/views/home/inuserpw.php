          ...
          <div class="card-body">
            <form method="POST" action="<?= base_url();?>/admin/adduser">
              <div class="form-group">
                ...
                <input readonly type="text" class="form-control" name="tingkatan" value="PW"/>
              </div>
              <div class="form-group">
                <label>Daerah/Pimpinan</label>
                <select name="id_pimpinan" class="form-control">
                  <option  value="<?= $pimpinan_default['id_pimpinan']; ?>"><?= $pimpinan_default['nama_pimpinan']; ?></option>
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="level" value="superuser"/>
              </div>
              <div class="form-group">
