    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <!-- /.card-header -->
          <div class="card-body">
            <form method="GET" action="<?=base_url()?>admin/anggotapac">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        <select  class="form-control" id="id2" name="id2">
          <option>Pilih Anak Cabang</option>
          <?php foreach ($kecamatan as $pac): ?>
          <option id="id2" class="<?= $pac['id_pimpinan']; ?>" value="<?= $pac['id_pimpinan_ac']; ?>"><?= $pac['nama_pimpinan_ac']; ?></option>
          <?php endforeach; ?>
        </select>
        <script src="<?=base_url()?>template/jquery-1.10.2.min.js"></script>
        <script src="<?=base_url()?>template/jquery.chained.min.js"></script>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Anggota PAC <?= $get_pac['nama_pimpinan_ac']; ?> - <?= $get_pc['nama_pimpinan']; ?></h3>
              <a target="_blank" class="btn btn-warning" style="float:right;"
              href="<?=base_url(); ?>admin/printanggotapac?id=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id2']; ?>"><i class="fas fa-print"></i> Print</a>
              <a target="_blank" class="btn btn-info" style="float:right;margin-right:5px;" href="<?=base_url(); ?>admin/exportanggotapac?id=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id2']; ?>">
