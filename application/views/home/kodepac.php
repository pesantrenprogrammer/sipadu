        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <form method="GET" action="<?=base_url();?>admin/inpac">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <ul class="dropdown-menu">
                      <li class="dropdown-item"><a href="<?=base_url()?>admin/koderanting?id=<?= $pimp['id_pimpinan_ac']; ?>&id2=<?php echo $_GET['id']?>">Ranting</a></li>
                      <li class="dropdown-item"><a href="<?=base_url()?>admin/kodekomisariat?id=<?= $pimp['id_pimpinan_ac']; ?>&id2=<?php echo $_GET['id']?>">Komisariat</a></li>
                    </ul>
                    </span>
                    <a class='btn bg-maroon' title='Edit Data' href='<?=base_url()?>admin/editpac?id=<?= $pimp['id_pimpinan_ac']; ?>&id2=<?php echo $_GET['id']?>'><span class='fa fa-edit'></span></a>
                    </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
