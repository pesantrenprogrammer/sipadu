    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <!-- /.card-header -->
          <div class="card-body">
            <form method="GET" action="<?=base_url()?>admin/anggotapkpt">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        <select  class="form-control" id="id2" name="id2">
          <option>Pilih Anak Cabang</option>
          <?php foreach ($pkpt as $pkpt): ?>
          <option id="id2" class="<?= $pkpt['id_pimpinan']; ?>" value="<?= $pkpt['id_pimpinan_ac']; ?>">PKPT <?= $pkpt['nama_pimpinan_ac']; ?></option>
          <?php endforeach; ?>
        </select>
        <script src="<?=base_url()?>template/jquery-1.10.2.min.js"></script>
        <script src="<?=base_url()?>template/jquery.chained.min.js"></script>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              href="<?=base_url(); ?>admin/printanggotapkpt?id=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id2']; ?>"><i class="fas fa-print"></i> Print</a>
              <a target="_blank" class="btn btn-info" style="float:right;margin-right:5px;" href="<?=base_url(); ?>admin/exportanggotapkpt?id=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id2']; ?>">
                <i class="fas fa-download"></i> Export Excel</a>
              <a class="btn btn-danger" style="float:right;margin-right:10px;"
              href="<?=base_url(); ?>admin/inanggotapkpt?id=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id2']; ?>"><i class="fas fa-plus"></i> New Data</a>
            </div>
