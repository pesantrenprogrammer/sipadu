          ...
          <div class="card-body">
            <form method="POST" action="<?= base_url();?>/admin/adduser">
              <div class="form-group">
                ...
                <input readonly type="text" class="form-control" name="tingkatan" value="PR"/>
              </div>
              <div class="form-group">
                <label>Daerah</label>
                <select name="id_pimpinan" class="form-control">
                  <?php foreach ($ranting as $pr): ?>
                  <option  value="<?= $pr['id_pimpinan_rk']; ?>"><?= $pr['nama_pimpinan_rk']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" class="btn bg-olive" name="save" value="Save"/>
              </div>
            </form>
          </div>
          <!-- /.card-body -->
