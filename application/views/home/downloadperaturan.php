        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a class='btn btn-info' title='Buat Surat' href='<?=base_url()?>admin/indownloadperaturan'>
                  </span> New Data</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body table-responsive p-o">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $dp['keterangan']; ?></td>
                  <td>
                  <a class='btn btn-danger tombol-hapus' title='Hapus Data' href='<?=base_url()?>admin/deletedownloadperaturan?id=<?= $dp['id_peraturan']; ?>'><span class='fas fa-trash'></span></a></td>
                </tr>
                <?php endforeach; ?>
