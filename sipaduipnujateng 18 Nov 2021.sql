...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2021 at 09:11 PM
...
INSERT INTO `admin_users` (`id_user`, `id_pimpinan`, `username`, `password`, `kategori_user`, `tingkatan`, `sekretariat`, `email`, `no_telpon`, `nama_lengkap`, `level`, `aktif`, `foto`) VALUES
(114, 18, 'adnan', '1234', '1', 'PW', 'Jl. Dr. Cipto 180 Semarang', 'nandcbp@gmail.com', '085741300425', 'Muhamad Adnan', 'superuser', 'Y', '20210612001907-184403845_2968856643335383_8419863139441398968_n.jpg'),
(170, 263, 'juki', 'juki', '1', '', '-', 'sijuky@gmail.com', '-', 'Marzuqi Rouf', 'anggota', 'Y', NULL),
(159, 263, 'ipnumagelang', 'ipnumagelang', '1', 'PC', 'Jl Gebang', 'mbahdoyok@wagers.id', '082226848282', 'wagers.id', 'user', 'Y', '20210611230047-profile_photo-190x190.jpg'),
(160, 262, 'ipnubandongan', 'ipnubandongan', '1', 'PAC', 'Jl. Krajan Baledono No.3, Rw. III, Tambakrejo, Kec. Purworejo, Kabupaten Purworejo, Jawa Tengah 54118', 'mbahdoyok@wagers.id', '082226848282', 'Hasan', 'user', 'Y', '20210612085818-profile_photo-190x190.jpg'),
(169, 18, 'hania', 'adnan', '0', 'PW', 'Jl. Dr. Cipto 180 Semarang', 'haniakhumaira@gmail.com', '085741300425', 'Hania Khumaira', 'superuser', 'Y', NULL);
...
(0, 0, '', '', NULL, '', '', NULL, '', ''),
(37, 18, 'no-image.jpg', 'Syaeful Kamaludin', '-', 'no-image.jpg', 'Fathurrochman Wahid', '-', 'no-image.jpg', 'no-image.jpg');
...
--
ALTER TABLE `admin_users`
  MODIFY `id_user` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT for table `anggota`
--
ALTER TABLE `anggota`
  MODIFY `id_anggota` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
...
--
ALTER TABLE `pengaturan_pimpinan`
  MODIFY `id_pengaturan_pimpinan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `pimpinan`
  MODIFY `id_pimpinan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `pimpinan_ac`
--
ALTER TABLE `pimpinan_ac`
  MODIFY `id_pimpinan_ac` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=264;

--
-- AUTO_INCREMENT for table `pimpinan_rk`
--
ALTER TABLE `pimpinan_rk`
  MODIFY `id_pimpinan_rk` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=994;
