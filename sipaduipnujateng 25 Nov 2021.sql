...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2021 at 01:05 AM
...
(170, 18, 'juki', 'juki', '1', 'PW', '-', 'sijuky@gmail.com', '-', 'Marzuqi Rouf', 'anggota', 'Y', NULL),
...
(160, 262, 'ipnubandongan', 'ipnubandongan', '1', 'PAC', 'Jl. Bandongan Magelang\r\n', 'mbahdoyok@wagers.id', '082226848282', 'Hasan', 'user', 'Y', '20210612085818-profile_photo-190x190.jpg'),
...
(37, 18, '180_logo.jpg', 'Syaeful Kamaludin, S.Pd', '-', 'C.png', 'Fathurrochman Wahid, S.H', '-', 'no-image.jpg', 'no-image.jpg');
...
--
ALTER TABLE `admin_users`
  MODIFY `id_user` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;
...
--
ALTER TABLE `pimpinan_ac`
  MODIFY `id_pimpinan_ac` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=270;

--
-- AUTO_INCREMENT for table `pimpinan_rk`
--
ALTER TABLE `pimpinan_rk`
  MODIFY `id_pimpinan_rk` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=996;
